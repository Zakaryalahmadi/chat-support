      ...
      onConnect: (frame) => {
        ...
        this.stompClient?.subscribe('/topic/public', (message: Message) => {
          ...
          try {
            ...
            this.messageSubject.next(parsedMessage); // Pass the message to subscribers
          } catch (error) {
        ...
        // Simulate a JOIN message if the server doesn't send one
        setTimeout(() => {
          const joinMessage = {
            sender: username,
            type: 'JOIN',
          ...
          console.log('Simulating JOIN message:', joinMessage);
